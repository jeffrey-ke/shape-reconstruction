...
def fit_voxel(voxels_src, voxels_tgt, args):
    ...
    for step in range(start_iter, args.max_iter):
        iter_start_time = time.time()
        # trying to see whether voxels_src is all probabilities...
        # voxels_tgt is non probability..
...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        # visualization
        src_path = "results/voxel_src.gif"
        tgt_path = "results/voxel_tgt.gif"
        render_voxels(voxels_src, voxels_tgt, src_path=src_path, tgt_path=tgt_path, dst=5)
        # use https://pytorch3d.org/docs/cubify
        ...
        # visualize
        pointclouds_src, pointclouds_tgt = create_p3d_pc(pointclouds_src), create_p3d_pc(pointclouds_tgt)
        render_pc(pointclouds_src, pointclouds_tgt, src_path="results/pc_src", tgt_path="results/pc_tgt", dist=2)
        ...
        # render
        render_mesh(mesh_src, mesh_tgt, src_path="results/mesh_src", tgt_path='results/mesh_tgt', dist=2)
